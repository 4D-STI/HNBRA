...
export default function ListSession({ subSessions: subSessions }: SubSessionProps) {
            ...
            <Table className="w-full">
                ...
                <TableBody>
                    {paginatedSubSessions.map((subSession, index) => (
                        ...
                        >
                            <TableCell className="text-left px-4 py-2">{subSession.nameSubSession.slice(0, -4)}</TableCell>
